...
- whether the board contains sections
- whether `_download_report.json` was created inside the ZIP
...
Do not post sensitive security issues publicly. See [SECURITY.md](SECURITY.md).
